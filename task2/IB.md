...
| 4   | Реализован ли принцип минимальных привилегий при назначении ролей и прав доступа?                                                        |   Нет    | есть широкие роли: менеджер, аналитик, бухгалтер             |
...
| 8   | Используются ли системы аутентификации пользователей для доступа к системам?                                                             |    Да   | ActiveDirectory             |
| 9   | Созданы ли замкнутые контуры для подсистем, работающих с чувствительными данными?                                                        | Нет      |     Некоторые системы не находятся в замкнутом контуре, например CRM         |
...
| 14  | Используются ли средства централизованного контроля доступа?                                                                            |    Да   | Но для некоторые систем вынесен свой AD              |
...
| 6   | Как часто проводятся внутренние и внешние аудиты безопасности? Обновляются ли политики и процедуры на основе результатов этих аудитов?  |    Редко   |        Один сотрудник СИБ на всю компанию       |
...
| 4   | Настроены ли политики автоматического резервного копирования в облачной среде? Контролируется ли доступ к резервным копиям?              |    Да   |       Но неизвестно, как контролируется доступ      |
